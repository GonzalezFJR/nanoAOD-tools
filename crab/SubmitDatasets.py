...
def CrateCrab_cfg(datasetName, isData = False, isTest = False, productionTag = 'prodTest', year = 0, options = '', outTier = 'T2_US_Nebraska'):
  ...
  if 'phys03' in options: 
    print 'Setting datatype to phys03!' 
    datatype = 'phys03'
...
def SubmitDatasets(path, isTest = False, prodName = 'prodTest', doPretend = False, options = '', outTier='T2_US_Nebraska'):
...
if narg == 0:
  ...
  print ' > --nutTier'
  print ' >   Select your Tier... by default: T2_US_Nebraska'
  print ' '
  print ' > Examples:'
...
def __main__():
  ...
  parser.add_argument('--outTier'    , default='T2_US_Nebraska' , help = 'Your output tier')
